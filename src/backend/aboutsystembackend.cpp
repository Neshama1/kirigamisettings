...
AboutSystemBackend::AboutSystemBackend(QObject *parent)
    : QObject(parent)
{
}
/*
bool AboutSystemBackend::isCutefishOS()
{
...
*/
QString AboutSystemBackend::version()
{
    QSettings settings("/etc/cutefish", QSettings::IniFormat);
    return settings.value("Version").toString();
}

QString AboutSystemBackend::osName()
{
    return QSysInfo::prettyProductName();
}

QString AboutSystemBackend::architecture()
{
    return QSysInfo::currentCpuArchitecture();
}

QString AboutSystemBackend::kernelType()
{
    return QSysInfo::kernelType();
}

QString AboutSystemBackend::kernelVersion()
{
    return QSysInfo::kernelVersion();
}

QString AboutSystemBackend::hostname()
{
    return QSysInfo::machineHostName();
}

QString AboutSystemBackend::userName()
{
...
QString AboutSystemBackend::memorySize()
{
    QString ram;
...
QString AboutSystemBackend::prettyProductName()
{
    return QSysInfo::prettyProductName();
}

QString AboutSystemBackend::internalStorage()
{
...
QString AboutSystemBackend::cpuInfo()
{
...
/*
void AboutSystemBackend::openUpdator()
{
    QProcess::startDetached("cutefish-updator", QStringList());
}
*/
qlonglong AboutSystemBackend::calculateTotalRam() const
{
    qlonglong ret = -1;
#ifdef Q_OS_LINUX
    struct sysinfo info;
