...
#ifndef ABOUTSYSTEMBACKEND_H
#define ABOUTSYSTEMBACKEND_H
...
class AboutSystemBackend : public QObject
{
    Q_OBJECT
...
public:
    explicit AboutSystemBackend(QObject *parent = nullptr);
